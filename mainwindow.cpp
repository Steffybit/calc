...
}// создание родительского окна для дальнеёшей работы с виджетом.
...
QLayout *MainWindow::createHeaderLayout()
{
    ...
    return headerLayout;
} // добавляем структуру заголовка на нашем виджете.
...
QLayout *MainWindow::createLineEditLayout()
{
    ...
    return pInLayout;
}// добавляем ещё кнопку, и добавляем 2 виджета .
...
}//добавляем клавиатуру и функцию с кнопкой.
...
}// добавляем логический цикл системы.
